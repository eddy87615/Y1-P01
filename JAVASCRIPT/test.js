...
const newQuiz = [
  ...
  },
  {
    ...
    content: `専門学校にはやっぱり就職でしょう？これからどんな事があるのを先に知った方がいいと思います。`,
  ...
  },
  {
    ...
    content: `課題が多いですから、自分のスケジュールを<br>きちんと管理しないといけないですよ！`,
    img: `img/project.png`,
    bubble: ``,
  },
  {
  ...
  },
  {
    ...
    content: `Webデザイン科の三つの柱は「コミュニケーション力」「考える力」「作る力」です。<br>覚えてください！大事な力ですよ！`,
    img: ``,
    bubble: ``,
  },
];
